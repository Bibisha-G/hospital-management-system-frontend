                        ...
                        <form className='form-wraper contact-form ajax-form'>
                            ...
                            <div className='row'>
                                <div className='form-group col-md-12'>
                                    <input type="text" name='name' required className='form-control' placeholder='Your Name'></input>
                                </div>
                                <div className='form-group col-md-12'>
                                    <input type="email" name='email' required className='form-control' placeholder='Email'></input>
                                </div>
                                <div className='form-group col-md-12'>
                                    <input type="text" name='phone' required className='form-control' placeholder='Phone Numbers'></input>
                                </div>
                                <div className='form-group col-md-12'>
                        ...
                        <div className='contact-info ovpr-dark'>
                            <div className='info-inner'>
                                ...
                                <div className='icon-box'>
                                   ...
                                   <p>nfo@yourdomain.com <br/>(+68) 120034509</p>
                                </div>
                                <div className='icon-box'>
                                   <h6 className='title'>
                                      <TbWorld/>
